...
A herança foi aplicada na classe PacienteEspecial, que herda da classe Paciente; O polimorfismo foi aplicado ao utilizar objetos de PacienteEspecial no lugar de Paciente, usando métodos sobrescitos de forma dinâmica; O encapsulamento foi aplicado em todas as classes por meio do uso de atributos privados e métodos getters e setters para controlar o acesso aos dados
---
## Prints da Execução

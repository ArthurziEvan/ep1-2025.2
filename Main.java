...
public class Main {
    ...
    static void cadastrarPaciente() {
        ...
        System.out.print("Possuí plano de saúde? (S/N): ");
    ...
    static void carregarDados() {
        pacientes = Persistencia.lerPacientes("data/pacientes.csv");
        medicos = Persistencia.lerMedicos("data/medicos.csv");
        planos = Persistencia.lerPlanos("data/planos.csv");
    }

    static void salvarDados() {
        Persistencia.salvarPacientes("data/pacientes.csv", pacientes);
        Persistencia.salvarMedicos("data/medicos.csv", medicos);
        Persistencia.salvarPlanos("data/planos.csv", planos);
    }
}
